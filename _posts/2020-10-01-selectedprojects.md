...
<div style="margin-bottom: 20px;">
  ...
  <div style="display: flex; align-items: center; background-color: rgb(206, 212, 218); color: black; border-radius: 4px; overflow: hidden;">
    ...
    <div style="flex: 2; padding-left: 1px; padding-top: 12px; padding-bottom: 13px; margin-left: 30px;">
      ...
      <p style="margin: -1px 0;"><a href="https://openaccess.thecvf.com/content/CVPR2024/html/Zheng_PKU-DyMVHumans_A_Multi-View_Video_Benchmark_for_High-Fidelity_Dynamic_Human_Modeling_CVPR_2024_paper.html" target="_blank">[Paper]</a> | <a href="https://pku-dymvhumans.github.io/" target="_blank">[Project Page]</a> | <a href="https://github.com/zhengxyun/PKU-DyMVHumans" target="_blank">[Code]</a></p>
    </div>
  </div>
...
<div style="margin-bottom: 20px;">
  ...
  <div style="display: flex; align-items: center; background-color: rgb(206, 212, 218); color: black; border-radius: 4px; overflow: hidden;">
    <div style="flex: 1;">
      <img src="/paper_sos_teaser.png" style="max-height: 120pt; margin-top: 12px; margin-left: 35px;">
    </div>
    <div style="flex: 2; padding-left: 1px; padding-top: 12px; padding-bottom: 13px; margin-left: 30px;">
      ...
      <p style="margin: -1px 0;"><a href="https://ieeexplore.ieee.org/abstract/document/10471326" target="_blank">[Paper]</a> | <a href="https://zhengxyun.github.io/Surface-SOS/" target="_blank">[Project Page]</a></p>
    </div>
  </div>
